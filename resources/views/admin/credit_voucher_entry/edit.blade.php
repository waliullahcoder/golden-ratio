...
@section('content')
    <div class="row g-3">
        <div class="col-lg-4 col-sm-6">
            ...
            <select name="debit_head" id="debit_head" class="chosen-select" data-placeholder="select Account Name" required>
        ...
        <div class="col-lg-4 col-sm-6">
            <label for="credit_heads" class="form-label"><b>Debit Account Head <span
                        class="text-danger">*</span></b></label>
            <select name="credit_heads" id="credit_heads" class="chosen-select" data-placeholder="select Debit Head">
                <option value="">Select Account Name</option>
