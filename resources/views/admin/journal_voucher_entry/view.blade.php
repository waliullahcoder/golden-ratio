    ...
    <div class="card">
        <div class="card-header pe-2 py-2">
            <div class="d-flex flex-wrap justify-content-between gap-2 align-items-center">
                ...
                <a href="{{ Route('admin.journal-voucher-entry.index') }}" class="btn btn-primary btn-sm">Go
                    Back</a>
            </div>
        </div>
            ...
            <table class="table table-borderless table-striped table-responsive-sm">
                <tbody>
                    <tr>
                        ...
                        <th width="10">:</th>
                        <td>{{ @$journalEntry->company->name }}</td>
                    </tr>
                    <tr>
                        <th width="200">Credit Account Head Name</th>
                        <th width="10">:</th>
                        <td>{{ @$journalEntry->coa->head_name }} - {{ @$journalEntry->coa->head_code }}</td>
                    </tr>
                    <tr>
