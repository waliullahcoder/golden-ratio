<div class="navbar-header bg-white shadow-sm" style="background-color: #edfffd !important">
    <div class="px-sm-3 px-10px d-flex gap-2 align-items-center justify-content-between">
        ...
        <div class="d-flex align-items-center">
            <div class="dropdown ms-sm-3 header-item topbar-user">
                <button type="button" class="btn btn-light rounded-0 border-0" data-bs-toggle="dropdown"   style="background-color: #edfffd !important">
